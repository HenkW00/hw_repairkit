...
local resourceName = "hw_repairkit"


    CreateThread(function()
        if GetCurrentResourceName() ~= "hw_repairkit" then
            resourceName = "hw_repairkit (" .. GetCurrentResourceName() .. ")"
        end
    end)

    CreateThread(function()
        while true do
            PerformHttpRequest("https://api.github.com/repos/HenkW00/hw_repairkit/releases/latest", CheckVersion, "GET")
            Wait(3600000)
        end
    end)
    ...
    GetRepoInformations = function()
        ...
        PerformHttpRequest("https://api.github.com/repos/HenkW00/hw_repairkit/releases/latest", function(err, response, headers)
            if err == 200 then
                ...
                repoURL = "https://github.com/HenkW00/hw_repairkit"
